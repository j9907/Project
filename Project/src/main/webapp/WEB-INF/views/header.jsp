...
<body>
            ...
            <ul class="heder_ul">
               	<c:if test="${empty login }">
                    ...
                    <ul>
               		...
               		<li class="temp"><a href="${cpath }/mypage"><img src="${cpath }/uploadFile/${login.profile}" width="40" height="40" class="header_img"> ${login.name } 님</a></li>
               	</c:if>
        ...
        function connectWs(){
        	...
        	sock.onmessage = function(evt){
        		...
        		toastr.info(data, '알림', {timeOut: 5000});
